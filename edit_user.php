     ...
     <div class="panel panel-default">
       <div class="panel-heading">
        <strong>
          ...
          <?php echo _('Update');?> <?php echo remove_junk(ucwords($e_user['name'])); ?> <?php echo _('Account');?>
        </strong>
       </div>
            ...
            <div class="form-group">
              <label for="status"><?php echo _('Status');?></label>
                <select class="form-control" name="status">
                  <option <?php if($e_user['status'] === '1') echo 'selected="selected"';?>value="1"><?php echo _('Active');?></option>
                  <option <?php if($e_user['status'] === '0') echo 'selected="selected"';?> value="0"><?php echo _('Deactive');?></option>
                </select>
            </div>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          <span class="glyphicon glyphicon-th"></span>
          <?php echo _('Change');?> <?php echo remove_junk(ucwords($e_user['name'])); ?> <?php echo _('password');?>
        </strong>
      </div>
      <div class="panel-body">
        <form action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
          ...
          <div class="form-group clearfix">
                  <button type="submit" name="update-pass" class="btn btn-danger pull-right"><?php echo _('Change');?></button>
          </div>
        </form>
      </div>
    </div>
