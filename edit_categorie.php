     ...
     <div class="panel panel-default">
       <div class="panel-heading">
         <strong>
           ...
           <span><?php echo _('Editing');?> <?php echo remove_junk(ucfirst($categorie['name']));?></span>
        </strong>
       </div>
       <div class="panel-body">
         <form method="post" action="edit_categorie.php?id=<?php echo (int)$categorie['id'];?>">
           ...
           <button type="submit" name="edit_cat" class="btn btn-primary"><?php echo _('Update categorie');?></button>
       </form>
       </div>
     </div>
   </div>
